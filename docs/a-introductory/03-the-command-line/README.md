...
The duration for which the terminal has been running is printed to the terminal
...
the man commad is used to print a manual of any terminal command, an example is man ls
...
This is done by using the date command
